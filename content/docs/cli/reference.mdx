...
In non-interactive environments such as CI/CD pipelines, you must combine this with the `--auto-approve` flag
...
This is primarily used in non-interactive environments such as CI/CD pipelines.
