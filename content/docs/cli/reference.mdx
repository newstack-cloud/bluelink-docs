...
Through the use of these commands, the pipeline can import the deployment state from the previous run of the pipeline and deploy it to the same environment.
